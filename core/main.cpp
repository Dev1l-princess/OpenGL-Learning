...
"layout (location = 0) in vec3 aPos;\n" // координатные переменные в атрибуте идут первыми среди всех остальных данных, поэтому указываем для них location = 0
"out vec4 vertexColor;\n" // определяем выходную переменную, задающую цвет, которую затем отправим во фрагментный шейдер
"void main()\n"
"{\n"
"   gl_Position = vec4(aPos.x, aPos.y, aPos.z, 1.0);\n" // обратите внимание, что в конструктор переменной типа vec4 мы напрямую передаем переменную типа vec3
"   vertexColor = vec4(0.0, 0.0, 1.0, 1.0);\n" // задаем значение цвета для выходной переменной
"}\0";

const char* fragmentShaderSource = "#version 330 core\n"
"out vec4 FragColor;\n"
"in vec4 vertexColor;\n" // входная переменная из вершинного шейдера (такое же имя и такой же тип)
"void main()\n"
"{\n"
